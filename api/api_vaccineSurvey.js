...
router.get('/survey/:divisionCode', async (req, res) => {
	try {
	  ...
	  CONVERT(VARCHAR, dateadd(HOUR , 7 ,a.[firstVaccineDate]) , 105) as 'ระบุวันที่ฉีดเข็มที่ 1',
	  CONVERT(VARCHAR, dateadd(HOUR , 7 ,a.[seccondVaccineDate]) , 105) as 'ระบุวันที่ฉีดเข็มที่ 2' ,
	  CONVERT(VARCHAR, dateadd(HOUR , 7 ,a.[thirdforthVaccineDate]) , 105) as 'ระบุวันที่ฉีดเข็มที่ 3',
	  CONVERT(VARCHAR, dateadd(HOUR , 7 ,a.[fourthVaccineDate]), 105) as 'ระบุวันที่ฉีดเข็มที่ 4' ,
